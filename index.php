    ...
    <nav class="navbar navbar-expand-lg  bg-primary navbar-light bg-white  py-3  fixed-top ">
        ...
        <section id="smartphones" class="my-5 ">
            ...
            <div class="row mx-auto container-fluid">
               ...
               <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                   <img class="img-fluid mb-3" src="assets/imgs/smartphone1.jpg"/>
                   <div class="star">
                       <i class="fas fa-star" style="color:yellow"></i>
                       <i class="fas fa-star" style="color:yellow"></i>
                       <i class="fas fa-star" style="color:yellow"></i>
                   ...
                   <h5 class="p-name">Air 3 Buds Tws Earbuds With Active Noise Cancellation</h5>
                   <h4 class="p-price">$99.00</h4>
                   <button class="buy-btn">Buy Now</button>
               </div>
               <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                   <img class="img-fluid mb-3" src="assets/imgs/smartphone2.jpg"/>
                   <div class="star">
                       <i class="fas fa-star" style="color:yellow"></i>
                       <i class="fas fa-star" style="color:yellow"></i>
                       <i class="fas fa-star" style="color:yellow"></i>
